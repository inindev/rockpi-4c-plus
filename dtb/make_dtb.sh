...
main() {
    local linux='https://cdn.kernel.org/pub/linux/kernel/v6.x/linux-6.4.11.tar.xz'
    local lxsha='546b68b5097d3c0d74722de62aae217729d98e45fbb6bd458b490ac21ea40918'
    ...
    if is_param 'links' "$@"; then
        local rkf rkfl='rk3399-rock-4c-plus.dts rk3399.dtsi rk3399-t-opp.dtsi'
        for rkf in $rkfl; do
            ln -sfv "$rkpath/$rkf"
        done
        echo '\nlinks created\n'
    ...
    # build
    local dt dts='rk3399-rock-4c-plus'
